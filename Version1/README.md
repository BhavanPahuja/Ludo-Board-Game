...
Team Project (Group 14) Ludo Board Game
...
The classes are: Board - Prints the board and responsible for moving tokens Dice - rolls the dice using random Token - Responsible for maintaining the properties of the Token like color and position User - responsible for maintaining the properties of the user like tokens, token color and the number rolled. Driver - the driver class runs the game and contains the main method.
